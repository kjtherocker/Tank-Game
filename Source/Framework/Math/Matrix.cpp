...
namespace GameDev2D
{
    ...
    Matrix Matrix::Make(Vector2 aTranslation, float aAngle, Vector2 aScale)
    {
        Matrix translation = Matrix::MakeTranslation(aTranslation);
        Matrix rotation = Matrix::MakeRotation(aAngle);
    ...
    Matrix Matrix::MakeRotation(float aAngle)
    {
        return MakeRotation(Rotation(aAngle));
    }
    ...
    void Matrix::SetRotation(float aAngle)
    {
        SetRotation(Rotation(aAngle));
    }
