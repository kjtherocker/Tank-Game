#ifndef __GameDev2D__Transformable__
#define __GameDev2D__Transformable__
...
namespace GameDev2D
{
    ...
    public:
        ...
        //Returns the parent object (if there is one) of the Transformable object
        Transformable* GetParent();

        //Call when you want to attach the Transformable object to a parent object,
        //it will then move, rotate and scale with its parent
        ...
        //Returns the Angle of the Transformable object
        float GetAngle();

        //Sets the Angle of the Transformable object
