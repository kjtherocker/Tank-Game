...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "GamePadButtonUpEvent", Log::Verbosity_Input_GamePad, "Controller on port: %u, button: %s released after %f seconds", m_GamePad->GetPort() + 1, GamePad::ButtonToString(m_Button).c_str(), m_Duration);
    }
}