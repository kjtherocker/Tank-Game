...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "GamePadButtonDownEvent", Log::Verbosity_Input_GamePad, "Controller on port: %u, button: %s pressed", m_GamePad->GetPort() + 1, GamePad::ButtonToString(m_Button).c_str());
    }
}