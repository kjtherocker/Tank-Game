...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "MouseMovementEvent", Log::Verbosity_Input_Mouse, "Mouse moved to position: (%f, %f) - Delta movement: (%f, %f)", m_Position.x, m_Position.y, m_DeltaPosition.x, m_DeltaPosition.y);
    }
}