...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "GamePadLeftThumbStickEvent", Log::Verbosity_Input_GamePad, "Controller on port: %u, left thumb stick: (%f, %f)", m_GamePad->GetPort() + 1, m_Value.x, m_Value.y);
    }
}