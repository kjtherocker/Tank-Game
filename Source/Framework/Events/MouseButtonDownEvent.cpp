...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "MouseButtonDownEvent", Log::Verbosity_Input_Mouse, "%s mouse button down at position (%f, %f)", Mouse::ButtonToString(m_Button), m_Position.x, m_Position.y);
    }
}