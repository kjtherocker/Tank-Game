...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "GamePadRightThumbStickEvent", Log::Verbosity_Input_GamePad, "Controller on port: %u, right thumb stick: (%f, %f)", m_GamePad->GetPort() + 1, m_Value.x, m_Value.y);
    }
}