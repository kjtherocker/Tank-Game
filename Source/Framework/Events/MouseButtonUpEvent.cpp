...
namespace GameDev2D
{
    ...
    {
        Log::Message(this, "MouseButtonUpEvent", Log::Verbosity_Input_Mouse, "%s mouse button up after being held for %f, at position (%f, %f)", Mouse::ButtonToString(m_Button), m_Duration, m_Position.x, m_Position.y);
    }
}